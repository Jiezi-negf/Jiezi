...
class Logger(object):
    def __init__(self, filename=path_Files + '/log_print.txt'):
...
print("drain electrostatic doping on z axis is from", z_translation + zlength_oxide + z_isolation, "to", z_total)
...
while iter_big < iter_big_max:
    ...
    G_R_fullE, G_lesser_fullE, G_greater_fullE, G1i_lesser_fullE, \
        ...
        SCBA(E_list, iter_SCBA_max, TOL_SCBA, ratio_SCBA, eta, mul, mur, Hii_new, Hi1_new, Sii_new,
    ...
    if residual < TOL_phi:
        ...
        print("hole:", p_tol)
        # phi2VTK(phi[:, 0].real, dof_coord_list, info_mesh, path_Files)
        # spectrumXY2Dat(E_list, length_single_cell, num_cell, path_Files, "SpectrumXYForCurrent.dat")
        # spectrumXY2Dat(E_list, length_single_cell, num_cell, path_Files, "SpectrumXYForOthers.dat")
        # spectrumZ2Dat(J_spectrum, path_Files, "currentSpectrum.dat")
        # spectrumZ2Dat(dos, path_Files, "densityOfState.dat")
        # spectrumZ2Dat(n_spectrum, path_Files, "electronSpectrum.dat")
        # spectrumZ2Dat(p_spectrum, path_Files, "holeSpectrum.dat")
        # print(dos)
        break
    else:
