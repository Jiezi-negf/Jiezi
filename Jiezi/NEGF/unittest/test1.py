...
class Test1(unittest.TestCase):
    ...
    def test_zigzagCNT_para(self):
        self.assertEqual(Test1.n_tol[0].real, 0.1124186749781545)
        self.assertEqual(Test1.n_tol[1].real, 0.11241592136958586)
        self.assertEqual(Test1.n_tol[2].real, 0.11241835944649411)

        self.assertEqual(Test1.dos[0][1], 1.43172812692925e-13)
        self.assertEqual(Test1.dos[0][2], 6.1581973527667403e-10)
        self.assertEqual(Test1.dos[1][0], 6.5228097721722976e-10)