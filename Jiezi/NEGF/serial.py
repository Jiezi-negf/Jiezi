...
def serial(mul, mur, Dirichlet_BC_gate, process_id):
    ...
    path_process_Files = os.path.abspath(os.path.join(path_Files, "process" + str(process_id)))
    ...
    class Logger(object):
        def __init__(self, filename=path_process_Files + '/log_print.txt'):
    ...
    cnt = builder.CNT(n=8, m=0, Trepeat=10, nonideal=False)
    cnt.construct()
    ...
    while iter_big < iter_big_max:
        ...
        if residual < TOL_phi:
            ...
            spectrumXY2Dat(E_list, length_single_cell, num_cell, path_process_Files, "SpectrumXYForCurrent.dat")
            # spectrumXY2Dat(E_list, length_single_cell, num_cell, path_process_Files, "SpectrumXYForOthers.dat")
