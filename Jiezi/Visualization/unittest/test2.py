...
class Test1(unittest.TestCase):
    ...
    def test_atom_connection(self):
        ...
        self.assertEqual(connection[0], ([1.2861840596014625e-16, -0.4674047707167568],
                                         [-2.1004979729615982, -2.047834103321604],
                                         [0.0, 1.3606721028332185]))

        self.assertEqual(connection[1], ([0.46740477071675973,
                                          -0.4674047707167568,
                                          0.46740477071675973,
                                          -3.3778583659194095e-16,
                                          0.46740477071675973,
                                          1.642235444121658],
                                         [-2.0478341033216036,
                                          -2.047834103321604,
