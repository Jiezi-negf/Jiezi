...
matrixWholeEK = w90.computeEKonKpath(kptList, hr_total_set, r_set, r_1, r_2, r_3, k_1, k_2, k_3)

num_kpt, num_band = matrixWholeEK.get_size()
axis_X = np.linspace(0, 3.8, num_kpt).reshape((num_kpt, 1))
dataXY = np.zeros((num_kpt, num_band + 1))
dataXY[0:, 0:1] = axis_X
dataXY[0:, 1:] = matrixWholeEK.get_value()
path = "/home/zjy/Documents/picture4CPC"
fileName = "/w90bandRank21.dat"
fname = path + fileName
