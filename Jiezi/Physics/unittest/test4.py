...
class Test4(unittest.TestCase):
    ...
    def test_mode_space(self):
        ...
        self.assertEqual(Hii_new[0].get_value()[0][0].real, -4.2646731359046255)
        self.assertEqual(Hi1_new[0].get_value()[0][0].real, -1.3282243786348751)
        self.assertEqual(Sii_new[0].get_value()[0][0].real, 1.0241495341569977)
