...
class Test3(unittest.TestCase):
    ...
    def test_band(self):
        ...
        self.assertEqual(band_[0].get_value()[0].real, -8.7191650853889868)
        self.assertEqual(band_[0].get_value()[15].real, 9.1226215644820332)
        self.assertEqual(band_[0].get_value()[0].imag, 0)
        self.assertEqual(band_[0].get_value()[15].imag, 0)
