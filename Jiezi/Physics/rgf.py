...
def rgf(ee, eta, mul, mur, Hii, Hi1, Sii, sigma_lesser_ph, sigma_r_ph):
    ...
    # TODO: consider change iter_max=50 assignment as default value in surface_gf
    ...
    g_0_lesser = op.trimatmul(g_0_R, \
                              op.addmat(sigma_lesser_ph[ee][0], Sigma_left_lesser), \
                              g_0_R, type="nnc")
    ...
    for i in range(1, nz-1):
        g_i_lesser = op.trimatmul(g_R[i], \
                                  op.addmat(sigma_lesser_ph[ee][i], \
