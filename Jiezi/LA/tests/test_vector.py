...
class TestVector(unittest.TestCase):
    ...
    def get_size(self):
        self.assertEqual(TestVector.vec.get_size(), (3,), "get_size is wrong")

    def set_value(self):
        TestVector.vec.set_value(0, 1 + 3j)
        TestVector.vec.set_value(1, 2 + 2j)
    ...
    def copy(self):
        ...
        self.assertTrue((TestVector.vec.get_value() == np.array([1. + 2.j, 2. + 3.j, 2])).all(), "copy is wrong")
